...
<form action="{{ route('tresle.store') }}" method="POST">
    @csrf
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="businessPrice" placeholder="Business Price">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Business City:</strong>
                <input type="text" name="businessCity" placeholder="Business City">
            </div>
        </div>
